...
def lire_fichier_mp(nom_fichier):
    T = []  # Liste pour stocker les valeurs de T
    C = []  # Liste pour stocker les valeurs de C
    ...
    with open(nom_fichier, 'r') as fichier:
        ...
        for ligne in lignes:
            valeurs = ligne.split()  # Séparer les valeurs sur chaque ligne
            if len(valeurs) == 2:
                T.append(int(valeurs[0]))  # Ajouter la première valeur à T
                C.append(int(valeurs[1]))  # Ajouter la deuxième valeur à C

    return T, C

# Lecture du fichier MP.txt
T, C = lire_fichier_mp("MP.txt")

# Appel de chaque algorithme avec les listes T et C
print("Résultats de la stratégie gloutonne :")
print(strategie_gloutonne(T, C, A, B))

print("\nRésultats de la fonction somme_max_recursive :")
print(somme_max_recursive(T, C, A, B))

print("\nRésultats de la fonction somme_max_top_down :")
print(somme_max_top_down(T, C, A, B))

print("\nRésultats de la fonction somme_max_bottom_up :")
